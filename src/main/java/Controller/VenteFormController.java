...
public class VenteFormController {
    ...
    public void setUser(User user) {
        this.user = user;
        System.out.println("[DEBUG] VenteForm - setUser called with id=" + (user != null ? user.getId() : "null") + " name=" + (user != null ? user.getPrenom() + " " + user.getNom() : "null"));
    }
    ...
    void save() {
        ...
        try {
            ...
            System.out.println("[DEBUG] VenteForm.save - userId=" + user.getId());
            if (editing != null) {
