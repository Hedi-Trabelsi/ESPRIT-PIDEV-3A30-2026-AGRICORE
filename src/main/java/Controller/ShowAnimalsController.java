...
public class ShowAnimalsController {
        ...
        animalListView.setCellFactory(param -> new ListCell<>() {
...

            {
                ...
                btnUpdate.setOnAction(event -> {
                    ...
                    try {
                        ...
                        NavigationUtil.loadInContentArea(animalListView, root);
                    } catch (Exception e) {
                        showAlert(e.getMessage());
                    }
                });
            ...
            protected void updateItem(Animal animal, boolean empty) {
                ...
                if (empty || animal == null) {
                    ...
                    Label espece = new Label("Espece : " + animal.getEspece());
    ...
    @FXML void navigateMeteo() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/fxml/MeteoSante.fxml"));
            NavigationUtil.loadInContentArea(animalListView, root);
    ...
    void navigateAddAnimal() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/fxml/AddAnimal.fxml"));
            NavigationUtil.loadInContentArea(animalListView, root);
        } catch (Exception e) {
            showAlert(e.getMessage());
        }
    ...
    void navigateShowSuiviAnimal() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/fxml/ShowSuiviAnimal.fxml"));
            NavigationUtil.loadInContentArea(animalListView, root);
        } catch (Exception e) {
            showAlert(e.getMessage());
        }
    ...
    void navigateNutrition() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/fxml/RecommandationAlimentaire.fxml"));
            NavigationUtil.loadInContentArea(animalListView, root);
        } catch (Exception e) { showAlert(e.getMessage()); }
    }
