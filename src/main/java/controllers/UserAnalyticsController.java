...
public class UserAnalyticsController {
    ...
    public void setUser(User user) {
        ...
        if (anomHost != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/AnomalyPage.fxml"));
                Parent root = loader.load();
                controllers.AnomalyPageController controller = loader.getController();
    ...
    void refreshAnalytics() {
        ...
        if (forecastLineChart != null) {
            ...
            models.ForecastResult fr = forecastingService.forecastUserSales(user.getId(), ventes, 6);
            XYChart.Series<String, Number> hist = new XYChart.Series<>();
            hist.setName("Ventes passées");
            for (models.ForecastPoint p : fr.getHistory()) {
            ...
            for (models.ForecastPoint p : fr.getForecast()) {
