...
public class AgriculteurController implements Initializable {
    ...
    private void genererPDF() {
        new Thread(() -> {
            try {
                ...
                String docDir  = System.getProperty("user.home") + java.io.File.separator + "Documents";
                new java.io.File(docDir).mkdirs();
                String outPath = docDir + java.io.File.separator + "Commande_" + numFull + ".pdf";
                ...
                y -= 24f;
                double sousTotal = 0;
                java.util.List<Panier> snap = new java.util.ArrayList<>(panierList);
                ...
                javafx.application.Platform.runLater(() -> {
                    ...
                    try { if (java.awt.Desktop.isDesktopSupported()) java.awt.Desktop.getDesktop().open(new java.io.File(path)); }
    ...
    private void fillRect(org.apache.pdfbox.pdmodel.PDPageContentStream cs,
                          java.awt.Color c, float x, float y, float w, float h) throws java.io.IOException {
    ...
    private void strokeRect(org.apache.pdfbox.pdmodel.PDPageContentStream cs,
                            java.awt.Color c, float lw, float x, float y, float w, float h) throws java.io.IOException {
    ...
    private void strokeLine(org.apache.pdfbox.pdmodel.PDPageContentStream cs,
                            java.awt.Color c, float lw, float x1, float y1, float x2, float y2) throws java.io.IOException {
    ...
    private void text(org.apache.pdfbox.pdmodel.PDPageContentStream cs,
                      ...
                      float size, java.awt.Color c, float x, float y, String txt) throws java.io.IOException {
    ...
    private void afficherToastPDF(String pdfPath, String numero) {
        ...
        openBtn.setOnAction(e -> { try { java.awt.Desktop.getDesktop().open(new java.io.File(pdfPath)); } catch (Exception ignored) {} });
    ...
    void ouvrirDetail(Equipement eq) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/DetailEquipement.fxml"));
