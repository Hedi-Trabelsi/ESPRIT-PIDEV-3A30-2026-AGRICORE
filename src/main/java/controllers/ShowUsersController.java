...
public class ShowUsersController {
    ...
    private Node buildCard(User user, int idx) {
        ...
        Button bO = btn("🛠 Outils",   "primary", e -> openUserOperations(user));
        Button bA = btn("📊 Analyses", "ghost",   e -> openUserAnalytics(user));
        Button bD = btn("📋 Détails",  "ghost",   e -> openFinanceFor(user));
    ...
    private void openFinanceFor(User u) {
        nav("/FinanceTables.fxml", l -> { FinanceTablesController c = l.getController(); c.setUser(u); });
    }
    private void openUserOperations(User u) {
        nav("/UserOperations.fxml", l -> { UserOperationsController c = l.getController(); c.setUser(u); });
    }
    private void openUserCalendar(User u) {
        nav("/UserCalendar.fxml", l -> { UserCalendarController c = l.getController(); c.setUser(u); });
    }
    private void openUserAnalytics(User u) {
        nav("/UserAnalytics.fxml", l -> { UserAnalyticsController c = l.getController(); c.setUser(u); });
    }
