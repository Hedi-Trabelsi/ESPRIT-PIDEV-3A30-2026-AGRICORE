...
public class SuiviAnimal {
    ...
    public SuiviAnimal(int idAnimal, Timestamp dateSuivi, double temperature, double poids,
                       int rythmeCardiaque, String niveauActivite, String etatSante, String remarque) {
    ...
    public Timestamp getDateSuivi() { return dateSuivi; }
    public void setDateSuivi(Timestamp dateSuivi) { this.dateSuivi = dateSuivi; }
    public double getTemperature() { return temperature; }
    public void setTemperature(double temperature) { this.temperature = temperature; }
    public double getPoids() { return poids; }
    public void setPoids(double poids) { this.poids = poids; }
    public int getRythmeCardiaque() { return rythmeCardiaque; }
    public void setRythmeCardiaque(int rythmeCardiaque) { this.rythmeCardiaque = rythmeCardiaque; }
